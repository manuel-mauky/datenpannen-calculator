...
public class StaticVirusDataProvider implements VirusDataProvider {
    ...
    private void initSecurityGovernanceActivityDistributions() {
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.EXTENSIVE_USE_OF_SECURITY_METRICS, .73);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.SUBSTANTIAL_TRAINING_AND_AWARENESS_ACTIVITIES, .7);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.EMPLOYMENT_OF_CERTIFIED_EXPERT_SECURITY_PERSONNEL, .64);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.FORMATION_OF_A_SENIOR_LEVEL_SECURITY_COUNCIL, .55);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.APPOINTMENT_OF_A_HIGH_LEVEL_SECURITY_LEADER, .48);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.ADEQUACY_OF_BUDGETED_RESOURCES, .39);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.CERTIFICATION_AGAINST_INDUSTRY_LEADING_STANDARDS, .36);
        securityGovernanceActivityDistributions.put(SecurityGovernanceActivity.NONE, 1d);
    }
