...
import de.hszg.datenpannen.data.virus.BaseDataProvider;
...
public class BaseDataModel {
    ...
    private MapProperty<de.hszg.datenpannen.model.virus.Sector, Double> attackCostPerSector = new SimpleMapProperty<>();
